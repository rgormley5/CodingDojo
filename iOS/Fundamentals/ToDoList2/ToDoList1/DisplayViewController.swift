...
extension DisplayViewController: AddNoteDelegate {
    func itemSaved(by controller: AddNoteViewController, itemInputText: itemInputText, datePickerInput: datePickerInput, notesInputText: notesInputText, at indexPath: NSIndexPath?) {
        print("in here")
